...
export default function SignUpScreen(props) {
  return (
    ...
    <TouchableOpacity onPress={()=> props.setSignIn(true)} className="h-[48px] w-[320px] justify-center items-center text-white bg-cyan-950 shadow-lg shadow-blue-400/50  rounded-full p-2 drop-shadow-2xl">
      <Text className="text-white text-xl font-bold tracking-wides ">
        Sign In
      </Text>
    </TouchableOpacity>
